...
public class HostManager {
    ...
    static {
    	addItem(new Host("217.76.87.104", "Stefan Larsson", "Gråstensvägen 3", "070-7441919"));
    	addItem(new Host("217.76.87.103", "Magnus Grenfeldt", "Gråstensvägen 2", "073-3668877"));
    	addItem(new Host("217.76.87.102", "Siverling", "Byv 12", "073-5415565"));
//    	addItem(new Host("217.76.87.115", "Eriksson", "Jökelv 13", "08-6210377"));
    	addItem(new Host("217.76.87.100", "Peter Lörne", "Jökelv 11", "08-7608516"));
    	addItem(new Host("217.76.87.117", "Dags eee", "", ""));
    	addItem(new Host("217.76.87.123", "Anders Thorsell", "Jökelv", ""));
    	addItem(new Host("217.76.87.124", "Sörenson", "Gråstensv 14", "08-7609686"));
//    	addItem(new Host("217.76.87.111", "Hallden", "Gråstensv 30", "08-7515414"));
//    	addItem(new Host("217.76.87.109", "Leufvenmark", "Brotorpsv 30", "08-6210304"));
    	...
    	addItem(new Host("217.76.87.116", "Lars Palm", "Byvägen", ""));
    	addItem(new Host("217.76.87.113", "Eiler Engberg", "Jökelv 10A", "08-361233, 070-8368091"));
    	addItem(new Host("217.76.87.114", "Kent Carlenäs", "Jökelv 10", "08-367362, 070-1711639"));
...
//    	addItem(new Host("217.76.87.121", "Mattias Jonasson", "Rullstensv 9", "070-5470016"));
    	...
    	addItem(new Host("217.76.87.126", "Router", "Sjöholm-Gullik", ""));
